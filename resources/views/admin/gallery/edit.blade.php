...
<div class="container-fluid">
	...
	<div class="card">
		<form action="/admin-gallery/{{ $image->id }}/update" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-lg-8">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('title', $image->name) }}">
                        @error('name')<small class="form-text text-danger mt-0">{{ $message }}</small>@enderror
                        
                        <label for="" class="mt-3">Image (.jpg/.jpeg/.png)</label>
                        <img src="/storage/{{ $image->image }}" class="img-preview d-block img-fluid mb-2 col-4">
